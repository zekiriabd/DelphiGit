...
// Version  : 1.0
// (23/10/2021 20:17:35 - - $Rev: 106319 $)
// ************************************************************************ //
...
type
  ...
  ['{A2E4D9CB-C96F-0965-87F0-E78269B29A8C}']
    function  NumberToWords(const ubiNum: Int64): WideString; stdcall;
    function  NumberToDollars(const dNum: TXSDecimal): WideString; stdcall;
  end;
